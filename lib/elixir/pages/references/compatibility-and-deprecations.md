...
[v1.20] | `Logger.enable/1`, `Logger.disable/1`, and `Logger.enabled?/1` | `Logger.delete_process_level/1`, `Logger.put_process_level/2`, and `Logger.get_process_level/1` respectively (v1.15)
